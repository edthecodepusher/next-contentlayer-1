...
export default function NavBar() {
  ...
  return (
    <header className="max-w-6xl bg-background text-foreground sticky top-0 z-50 w-full border-b border-border">
              ...
              <SheetContent side="left" className="bg-background">
                ...
                <div className="flex justify-center mt-6">
                  ...
                  >
                    ...
                    <Moon className="absolute h-5 w-5 rotate-90 scale-0 transition-all STEP dark:rotate-0 dark:scale-100" />
